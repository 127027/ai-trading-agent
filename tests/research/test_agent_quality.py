...
from agent_quality import enrich_regime, meta_learning_report, validate_research_plan  # noqa: E402
...
def test_raster4_rejects_signal_evidence_not_backed_by_completed_memory():
    ...
    try:
        validate_research_plan(plan, {"label": "bull_trend", "blind_window_seen": False}, {})
...
def test_raster6_detects_stagnation_and_requests_material_change():
    ...
    assert report["directive"] == "break_stagnation_force_materially_new_signal_hypothesis"
